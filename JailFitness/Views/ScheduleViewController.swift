...
extension ScheduleViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if(selectedRow == 0){
            //monday
            getNextVC(pathStr: "/workouts/lose_weight/mon",day: "Monday")
        }else if(selectedRow == 1){
            //tuesday
            getNextVC(pathStr: "/workouts/lose_weight/tue",day: "Tuesday")
        }else if(selectedRow == 2){
            //wednesday
            getNextVC(pathStr: "/workouts/lose_weight/wed",day: "Wednesday")
        }else if(selectedRow == 3){
            //thursday
            getNextVC(pathStr: "/workouts/lose_weight/thu",day: "Thursday")
        }else if(selectedRow == 4){
            //friday
            getNextVC(pathStr: "/workouts/lose_weight/fri",day: "Friday")
        }else if(selectedRow == 5){
            //saturday
            getNextVC(pathStr: "/workouts/lose_weight/sat",day: "Saturday")
        }else if(selectedRow == 6){
            //sunday
            getNextVC(pathStr: "/workouts/lose_weight/sun",day: "Sunday")
        }
    }
    
    @objc func getNextVC(pathStr:String, day:String){
            let vc = DayScheduleViewController()
            vc.path = pathStr
            vc.scheduleLabel.text = day
