...
class HeightViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    let coverImage : UIImageView = {
        ...
        imageView.image = UIImage(named: "heightImage")
    ...
    @objc func goToNext() {
        ...
        data.setValue(dHeight, forKey: "Height")
        
        if let heightText = textField.text, !heightText.isEmpty {
            navigateToNextPage()
            errorLabel?.removeFromSuperview()
        } else {
            displayErrorMessage("Missing height - Please enter your height")
        }
    }
    ...
    func pickerView(_ pickerView: UIPickerView, attributedTitleForRow row: Int, forComponent component: Int) -> NSAttributedString? {
        ...
        let attributedString = NSAttributedString(string: "\(height) cm", attributes: attributes)
